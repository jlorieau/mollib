...
.. raw:: html
    ...
    <span class="go">	hydrogenate     <font color="green">Enabled</font></span>
    <span class="go">	hbonds          <font color="green">Enabled</font></span>
    <span class="go">	pa              <font color="green">Enabled</font></span>
    </pre></div>
...
.. raw:: latex
  ...
  Installed plugins:
  	...
  	hydrogenate     \textcolor{olivegreen}{Enabled}
  	hbonds          \textcolor{olivegreen}{Enabled}
  	pa              \textcolor{olivegreen}{Enabled}
  \end{sphinxVerbatim}
 {} 
