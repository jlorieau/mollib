...
class Atom(Primitive):
    ...
    atom_Mw = {'H': 1.01, 'D': 2.00, 'Be': 9.01, 'B': 10.81, 'C': 12.01,
               ...
               'V': 50.94, 'Fe': 55.845,'Ni': 58.69, 'Co': 58.93, 'Cu': 63.55,
               'Zn': 65.38, 'Se': 78.96, 'As': 74.92, 'Br': 79.904, 'Zr': 91.22,
               'Mo': 95.94, 'Ru': 101.07, 'I': 126.90, 'W': 183.84,
               'Hg': 200.59, 'Pb': 207.2, 'U': 238.05}
