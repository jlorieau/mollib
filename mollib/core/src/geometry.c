...
static const char __pyx_k_measure_distance_line_34[] = "measure_distance (line 34)";
...
static PyObject *__pyx_kp_u_measure_distance_line_34;
 ...
 */
  ...
  __pyx_t_3 = -1;
  if (__pyx_t_7 < 0) {
    __pyx_t_7 += __pyx_pybuffernd_vi.diminfo[0].shape;
    if (unlikely(__pyx_t_7 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_7 >= __pyx_pybuffernd_vi.diminfo[0].shape)) __pyx_t_3 = 0;
  ...
  __pyx_t_3 = -1;
  if (__pyx_t_8 < 0) {
    __pyx_t_8 += __pyx_pybuffernd_vj.diminfo[0].shape;
    if (unlikely(__pyx_t_8 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_8 >= __pyx_pybuffernd_vj.diminfo[0].shape)) __pyx_t_3 = 0;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_3);
    __PYX_ERR(0, 65, __pyx_L1_error)
  }
 ...
 */
  ...
  __pyx_t_3 = -1;
  if (__pyx_t_9 < 0) {
    __pyx_t_9 += __pyx_pybuffernd_vi.diminfo[0].shape;
    if (unlikely(__pyx_t_9 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_9 >= __pyx_pybuffernd_vi.diminfo[0].shape)) __pyx_t_3 = 0;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_3);
  ...
  __pyx_t_3 = -1;
  if (__pyx_t_10 < 0) {
    __pyx_t_10 += __pyx_pybuffernd_vj.diminfo[0].shape;
    if (unlikely(__pyx_t_10 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_10 >= __pyx_pybuffernd_vj.diminfo[0].shape)) __pyx_t_3 = 0;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_3);
    __PYX_ERR(0, 66, __pyx_L1_error)
  }
 ...
 */
  ...
  __pyx_t_3 = -1;
  if (__pyx_t_11 < 0) {
    __pyx_t_11 += __pyx_pybuffernd_vi.diminfo[0].shape;
    if (unlikely(__pyx_t_11 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_11 >= __pyx_pybuffernd_vi.diminfo[0].shape)) __pyx_t_3 = 0;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_3);
  ...
  __pyx_t_3 = -1;
  if (__pyx_t_12 < 0) {
    __pyx_t_12 += __pyx_pybuffernd_vj.diminfo[0].shape;
    if (unlikely(__pyx_t_12 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_12 >= __pyx_pybuffernd_vj.diminfo[0].shape)) __pyx_t_3 = 0;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_3);
    __PYX_ERR(0, 67, __pyx_L1_error)
  }
...
static PyObject *__pyx_pw_8geometry_5measure_distance(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_atom_2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("measure_distance", 1, 2, 2, 1); __PYX_ERR(0, 34, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "measure_distance") < 0)) __PYX_ERR(0, 34, __pyx_L3_error)
      }
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("measure_distance", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 34, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_8geometry_4measure_distance(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_atom_1, PyObject *__pyx_v_atom_2) {
  ...
  __Pyx_RefNannySetupContext("measure_distance", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_8geometry_measure_distance(__pyx_v_atom_1, __pyx_v_atom_2, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_u_measure_distance_line_34, __pyx_k_measure_distance_line_34, sizeof(__pyx_k_measure_distance_line_34), 0, 1, 0, 0},
 ...
 *     normalization."""
 */
  __pyx_tuple__7 = PyTuple_Pack(5, __pyx_n_s_vector_i, __pyx_n_s_vector_j, __pyx_n_s_normalize, __pyx_n_s_vec, __pyx_n_s_length); if (unlikely(!__pyx_tuple__7)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__7);
  __Pyx_GIVEREF(__pyx_tuple__7);
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(3, 0, 5, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_jlorieau_Code_Python_Biop, __pyx_n_s_calc_vector, 23, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_u_measure_distance_line_34, __pyx_kp_u_Measure_the_atom_1_atom_2_distan) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
